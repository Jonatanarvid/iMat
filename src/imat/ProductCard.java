...
public class ProductCard extends AnchorPane implements FavouriteObservable {
    ...
    Image notFavouriteImage = new Image((getClass().getResourceAsStream("src/imat/resources/imat/egnabilder/unfilled_star.png")));
    Image isFavouriteImage = new Image((getClass().getResourceAsStream("src/imat/resources/imat/egnabilder/filled_star.png")));
